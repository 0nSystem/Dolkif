...
import org.dolkif.utils.StandardSystemProperties;
...
public class ReaderClass {
    ...
    private ReaderClass(@NonNull Set<Resource> resource){
        this.resource=resource;
    }

    public static ReaderClass of(ClassLoader classLoader){
        ...
        return new ReaderClass(resources);
    }
    ...
    private static List<URL> getJavaClassPath(){
        ...
        for (String entry : StandardSystemProperties.JAVA_CLASS_PATH.value()
                .split(StandardSystemProperties.PATH_SEPARATOR.value())
        ) {
            try {
                try {
                ...
                DolkifFactory.getLogger().log(Level.WARNING,"Error generated url in getJavaClassPath",e);
            }
        }
    ...
    public static class Resource{
        ...
        static Set<Resource> getResourcesByPath(@NonNull File location) throws NullPointerException{
            ...
            String[] replacePathClass = StandardSystemProperties.JAVA_CLASS_PATH.value().split(StandardSystemProperties.PATH_SEPARATOR.value());
